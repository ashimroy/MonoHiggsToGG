...
#metaConditions = MetaConditionsReader("/afs/cern.ch/work/a/arpurohi/public/H2gg/6March2023/CMSSW_10_6_29/src/flashgg/MetaData/data/MetaConditions/Era2017_RR-31Mar2018_v1.json")
metaConditions = MetaConditionsReader('$CMSSW_BASE/src/flashgg/MetaData/data/MetaConditions/Era2018_legacy_v1.json')
...
"/store/user/alesauva/flashgg/UL2018_0/10_6_4/EGamma/UL2018_0-10_6_4-v0-Run2018B-12Nov2019_UL2018-v2/201015_125241/0000/myMicroAODOutputFile_1.root"
#                               "/store/user/alesauva/flashgg/UL2018_0/10_6_4/EGamma/UL2018_0-10_6_4-v0-Run2018A-12Nov2019_UL2018-v2/201015_124153/0000/myMicroAODOutputFile_102.root"
#                               "/store/user/alesauva/flashgg/UL2018_0/10_6_4/EGamma/UL2018_0-10_6_4-v0-Run2018A-12Nov2019_UL2018-v2/201015_124153/0000/myMicroAODOutputFile_1.root"
...
if options.useVtx0:
    ...
    process.flashggDiPhotonsVtx0.useZerothVertexFromMicro = cms.bool(True)
    process.flashggDiPhotonsVtx0.vertexIdMVAweightfile = metaConditions['flashggDiPhotons']['vertexIdMVAweightfile'].encode("ascii")
    process.flashggDiPhotonsVtx0.vertexProbMVAweightfile = metaConditions['flashggDiPhotons']['vertexProbMVAweightfile'].encode("ascii")
else: sourcediphotons = "flashggDiPhotons" # BDT photons
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer_Legacy18',
				  ...
				  sampleIndex  		= cms.untracked.int32(index),
                                  ...
                                  puWFileName  		= cms.string('$CMSSW_BASE/src/MonoHiggsToGG/analysis/data/PU_Reweight_2018.root'),
